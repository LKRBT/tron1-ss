...
private:
    ...
    ///// map match
    double keyframe_dist_thr_,temp_keyframe_dist_thr_;
    double voxel_res_;
    ///// visualize
    ...
    std::vector<Eigen::Vector3d>  tf_pose_vec;
...
public:
    ...
    //     pass.setFilterLimits(-0.4, 0.4);  // 关键修改点：调整滤波范围
...
private:
    ...
    bool first_relocation_success = false;
    bool relocate_success_flag = false;
